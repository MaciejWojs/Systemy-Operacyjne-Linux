...
\end{Verbatim}
\vspace*{-10pt}
\fg{contents/configuration/phpMyAdmin/1.png}{MySQL – instalacja część druga}{MySQL – instalacja część druga}
\vspace*{-10pt}
...
\fg{contents/configuration/phpMyAdmin/3.png}{MySQL – instalacja część druga}{MySQL – instalacja część druga}
...
\vspace*{-10pt}
\fg{contents/configuration/UserDir/2.png}{MySQL – instalacja część druga}{MySQL – instalacja część druga}
...
\vspace*{-5pt}
\fg{contents/configuration/UserDir/3.png}{MySQL – instalacja część druga}{MySQL – instalacja część druga}

\newpage
Kod html tej strony
\fg{contents/configuration/UserDir/4.png}{MySQL – instalacja część druga}{MySQL – instalacja część druga}
